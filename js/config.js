...
angular.module('defaultLibrary').constant('CONFIG', {
    ...
    GET_TIME_URL: '{{API_BASE_URL}}/time/?lat={{lat}}&lng={{lng}}'.replace('{{API_BASE_URL}}',API_BASE_URL),
    ...
    GET_WEATHER_URL: '{{API_BASE_URL}}/weather/?lat={{lat}}&lng={{lng}}'.replace('{{API_BASE_URL}}',API_BASE_URL),
